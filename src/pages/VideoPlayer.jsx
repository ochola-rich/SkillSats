            ...
            {!invoice ? (
              ...
              <>
                ...
                <p className="text-gray-400 mb-6 max-w-md">
                  This video is locked. Support the creator directly via the Lightning Network to
                  unlock it instantly.
                </p>
                <button
              ...
              <div className="bg-white p-6 rounded-xl flex flex-col items-center max-w-sm w-full">
                <QRCodeSVG value={invoice} size={200} level="M" includeMargin={true} />

                <div className="mt-4 w-full">
                  <p className="text-gray-950 font-bold mb-2 text-center">
                    Pay {video.priceSats} sats
                  </p>
